...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/evandronascimento',
      icon: (
    ...
    {
      name: 'WhatsApp',
      href: 'https://wa.me/5581991787564',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  const quickLinks = [
    ...
    { name: t('nav.education'), href: '#educacao' },
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Evandro Nascimento</h3>
                <p className="text-gray-400 text-sm">Software Developer • Tech Lead</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">efraibo@gmail.com</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">(81) 99178-7564</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">Ipojuca, PE - Brasil</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <p className="text-gray-400 text-sm">
            © {currentYear} Evandro Nascimento. {t('footer.rights')}
          </p>
